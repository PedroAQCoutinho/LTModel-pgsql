...
-- ROLLBACK
--------------------
-- DELETE FROM recorte.params WHERE param_name = 'car_premium_tolerance';
-- DELETE FROM recorte.params WHERE param_name = 'car_table_name';
-- DELETE FROM recorte.params WHERE param_name = 'car_table_schema';
-- DELETE FROM recorte.params WHERE param_name = 'priority_autointersection';
-- DELETE FROM recorte.params WHERE param_name = 'car_area_loss_tolerance';
-- DELETE FROM recorte.params WHERE param_name = 'car_ci_minimum';