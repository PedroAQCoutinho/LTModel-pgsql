...
INSERT INTO recorte.v_pacotes_proc01_breakbiome
    SELECT
        a.cd_mun::int,
        b.id::int,
        ...
        END AS geom
    -- FROM recorte.:"mun_table_name" AS a
    -- JOIN recorte.:"biome_table_name" AS b
        FROM recorte.aux_pa_br_municipios_5572_2018 AS a
        JOIN recorte.aux_biomas_250_2019_ibge AS b
