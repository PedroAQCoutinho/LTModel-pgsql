...
=======
    ...
    psql -U $userName -h $databaseServer -d $databaseName -p $portNumber -c "DROP TABLE IF EXISTS lt_model.result_$varPriority;ALTER TABLE lt_model.result RENAME TO result_$varPriority; ALTER INDEX lt_model.gix_result RENAME TO gix_result_$varPriority; CREATE TABLE lt_model.result AS SELECT * FROM lt_model.result_$varPriority WHERE false; CREATE INDEX gix_result ON lt_model.result USING GIST (geom);"
>>>>>>> b219bc2919a5386d330518d737f9eb03fab21bb3
